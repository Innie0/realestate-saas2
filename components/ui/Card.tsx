...
export default function Card({
  ...
  const hoverStyles = hover ? 'transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 hover:border-white/20 hover:shadow-xl hover:shadow-black/40 cursor-pointer' : '';
