...
export default function Input({
  ...
  const baseStyles =
    'block w-full rounded-lg border px-3 sm:px-4 py-2 text-sm sm:text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/30 transition-all duration-200 bg-gray-50 border-gray-200';
  ...
  const inputClasses = clsx(
    ...
    error
      ...
      : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500/30 hover:border-gray-400',
    className
  );
