...
export default function Input({
  ...
  const baseStyles = 'block w-full rounded-lg border px-3 sm:px-4 py-2 text-sm sm:text-base text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all duration-200 bg-white/10 backdrop-blur-sm border-white/20 [color-scheme:dark]';
