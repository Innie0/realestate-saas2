          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:gap-5">
            {LANDING_FEATURE_CARDS.map((card) => (
              ...
              >
                ...
                <span className="absolute bottom-6 right-6 flex size-11 items-center justify-center rounded-full border border-[#EAEAEA] bg-[#C9E0FE] text-[#1C1D22] transition-colors group-hover:border-[#3548C7] group-hover:bg-[#3548C7] group-hover:text-white sm:bottom-8 sm:right-8">
                ...
                <li key={item.id}>
                  ...
                  >
                    <span className="flex min-w-0 items-center gap-3">
                      <span className="flex size-9 shrink-0 items-center justify-center rounded-lg bg-[#C9E0FE] text-[#3548C7]">
