...
export default function LandingCTABand() {
  return (
    <section className="mkt-grid-lines-bg border-t border-black/[0.08] py-20 sm:py-24 lg:py-28">
        ...
        <MarketingBlurFade inView>
          <LandingStaggerReveal className="mx-auto max-w-2xl text-center">
            ...
            >
              ...
              <a
                href="/pricing"
                className="inline-flex h-12 items-center justify-center rounded-mkt-button border border-mkt-border bg-white px-7 text-[15px] font-medium text-mkt-foreground transition-colors duration-200 hover:border-mkt-foreground"
              >
                See pricing
              </a>
            </div>
