  ...
  return (
    <section aria-label="Product features" style={{ backgroundColor: MKT.background }}>
      <div className="mx-auto px-5 sm:px-8" style={{ maxWidth: MKT.maxContentWidth }}>
        <LandingScrollReveal className="border-t py-24 sm:py-28 lg:py-32" style={{ borderColor: MKT.border }}>
          <p
          ...
          <p className="mt-5 max-w-xl text-base leading-[1.65]" style={{ color: MKT.textSecondary }}>
