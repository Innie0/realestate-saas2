  ...
  return (
    <Card>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-900">Upcoming Events & Reminders</h2>
        {items.length > 0 && (
          <span className="ml-auto bg-gray-100 text-gray-600 text-xs font-medium px-2 py-1 rounded-full border border-gray-300">
            {items.length}
          </span>
        )}
      </div>
      ...
      {items.length === 0 ? (
        <p className="text-gray-500 text-sm">No upcoming events or reminders in the next 7 days.</p>
      ) : (
