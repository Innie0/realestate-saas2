        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 lg:p-12">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-2">You are responsible for:</p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">You Agree To:</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">You Agree NOT To:</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Feedback Submissions</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-2">You are solely responsible for:</p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">Content Removal</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">Google Calendar & Microsoft Outlook</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">AI Tools and Conversation Memory</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">Conversation Data</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">No Financial or Legal Advice</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">Billing</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">Taxes</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">"As Is" Service</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">No Guarantees</h3>
              <p className="text-gray-600 leading-relaxed mb-2">We do not guarantee that:</p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Data Security and Backups</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">By You</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                You may terminate your account at any time by contacting us or using the account deletion feature.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">By Us</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">Dispute Resolution Process</h3>
              <p className="text-gray-600 leading-relaxed mb-2">In the event of a dispute:</p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">General Provisions</h2>
